...
export const translations: Translations = {
  NL: {
    ...
    "about.p1": "Welkom bij Reigersbos Medical Center, een kleinschalige huisartspraktijk gelegen aan de Reigersbos 100K op de 3e etage. Wij streven naar persoonlijke en kwalitatieve zorg en werken nauw samen met onze diëtist en fysiotherapeuten om u de beste zorg te bieden.",
    ...
    "about.p3": "We begrijpen dat elke patiënt uniek is en daarom vinden wij het belangrijk om persoonlijke zorg te bieden die is afgestemd op uw individuele behoeften. Onze diëtist en fysiotherapeuten werken nauw samen met onze huisartsen om u te helpen uw gezondheidsdoelen te bereiken.",
  ...
  EN: {
    ...
    "about.p1": "Welcome to Reigersbos Medical Center, a small-scale general practice located at Reigersbos 100K on the 3rd floor. We strive for personal and quality care and work closely with our dietitian and physiotherapists to provide you with the best care.",
    ...
    "about.p3": "We understand that every patient is unique and therefore we find it important to provide personal care tailored to your individual needs. Our dietitian and physiotherapists work closely with our GPs to help you achieve your health goals.",
  ...
  TW: {
    ...
    "about.p3": "Yɛhunu sɛ ɔyarefɔ biara yɛ onipa pa ara. Enti yɛpɛ sɛ yɛhyɛ wo ayɛ a ɛfata wo pɛpɛɛpɛ. Yɛn diëtist ne fysiotherapeuten yɛ adwuma ne yɛn adɔkono.",
