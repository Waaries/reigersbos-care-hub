  ...
  <Layout>
    <section className="page-hero">
      <div className="page-container" style={{ textAlign: "center" }}>
        ...
        <h1 className="page-hero-title">Praktijkondersteuner GGZ</h1>
        <p className="page-hero-desc">Ondersteuning bij psychosociale klachten, dichtbij en laagdrempelig.</p>
      </div>
    </section>
